...
export const metadata: Metadata = {
  title: "Reverse Engineering Services | 3D Scanning & CAD Conversion | CADCAMX",
  description: "Professional reverse engineering services including 3D scanning, point cloud processing, scan-to-CAD conversion, and legacy part digitization. Geomagic, PolyWorks expertise.",
  openGraph: {
    title: "Reverse Engineering Services | 3D Scanning | CADCAMX",
    description: "Professional reverse engineering and 3D scanning services for CAD conversion.",
    type: "website",
    url: "https://cadcamx.com/services/reverse-engineering",
  },
};
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl">
              Transform physical parts into precise digital models through advanced
              3D scanning and reverse engineering techniques. Perfect for legacy parts,
              design improvements, and quality inspection applications.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="flex flex-wrap gap-4">
              {["Geomagic Design X", "PolyWorks", "SolidWorks", "Fusion 360", "Artec Studio", "CloudCompare", "Wrap", "Mesh2Surface"].map((sw) => (
          ...
          <div className="bg-gradient-to-r from-accent-gold/20 to-accent-orange/20 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-300 mb-6">
              Contact us for a free quote on your reverse engineering project.
            </p>
